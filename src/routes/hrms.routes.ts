 ...
 */
router.put('/employees/:id', validate(createEmployeeSchema), auditLog('hrms', 'UPDATE', 'employee'), hrmsController.fullUpdateEmployee);
/**
 * @swagger
 * /hrms/employees/{id}:
 *   delete:
 ...
 *               $ref: '#/components/schemas/ApiError'
 */
router.delete('/employees/:id/permanent', checkPermission('EMPLOYEES', 'DELETE'), auditLog('EMPLOYEES', 'DELETE', 'Employee'), hrmsController.hardRemoveEmployee);
 ...
 *         $ref: '#/components/responses/InternalError'
 */
router.patch('/employees/:id/profile', validate(updateProfileSchema), auditLog('hrms', 'UPDATE', 'employee_profile'), hrmsController.updateEmployeeProfile);
 ...
 *         $ref: '#/components/responses/InternalError'
 */
router.patch('/employees/:id/status', validate(updateEmployeeStatusSchema), auditLog('hrms', 'UPDATE', 'employee_status'), hrmsController.updateEmployeeStatus);
 ...
 *         $ref: '#/components/responses/InternalError'
 */
router.post('/attendance/checkin', validate(checkinSchema), auditLog('attendance', 'CHECKIN', 'attendance'), hrmsController.checkin);
/**
 * @swagger
 ...
 *         $ref: '#/components/responses/InternalError'
 */
router.post('/attendance/checkout', validate(checkoutSchema), auditLog('attendance', 'CHECKOUT', 'attendance'), hrmsController.checkout);
 ...
 *         $ref: '#/components/responses/InternalError'
 */
router.post('/performance/goals', validate(createPerformanceGoalSchema), auditLog('performance', 'CREATE', 'goal'), hrmsController.createPerformanceGoal);
/**
 * @swagger
 ...
 *         $ref: '#/components/responses/InternalError'
 */
router.patch('/performance/goals/:id', validate(updatePerformanceGoalSchema), auditLog('performance', 'UPDATE', 'goal'), hrmsController.updatePerformanceGoal);
/**
 * @swagger
 ...
 *         $ref: '#/components/responses/InternalError'
 */
router.post('/performance/appraisal', validate(submitAppraisalSchema), auditLog('performance', 'SUBMIT', 'appraisal'), hrmsController.submitAppraisal);
/**
 * @swagger
 ...
 *         $ref: '#/components/responses/InternalError'
 */
router.post('/performance/feedback', validate(submitFeedbackSchema), auditLog('performance', 'SUBMIT', 'feedback'), hrmsController.submitFeedback);
 ...
 *         $ref: '#/components/responses/InternalError'
 */
router.post('/training/enroll', validate(enrollCourseSchema), auditLog('training', 'ENROLL', 'enrollment'), hrmsController.enrollCourse);
/**
 * @swagger
 ...
 *         $ref: '#/components/responses/InternalError'
 */
router.patch('/training/:enrollmentId/complete', validate(completeCourseSchema), auditLog('training', 'COMPLETE', 'enrollment'), hrmsController.completeCourse);
/**
 * @swagger
 ...
 *         $ref: '#/components/responses/InternalError'
 */
router.post('/transfers', validate(createTransferSchema), auditLog('hrms', 'CREATE', 'transfer'), hrmsController.createTransferRequest);
/**
 * @swagger
 ...
 *         $ref: '#/components/responses/InternalError'
 */
router.patch('/transfers/:id/approve', validate(approveRejectTransferSchema), auditLog('hrms', 'APPROVE', 'transfer'), hrmsController.approveRejectTransfer);
/**
 * @swagger
 * /hrms/promotions:
 *   post:
 ...
 *         $ref: '#/components/responses/InternalError'
 */
router.post('/promotions', validate(createPromotionSchema), auditLog('hrms', 'CREATE', 'promotion'), hrmsController.createPromotion);
 ...
 *         $ref: '#/components/responses/InternalError'
 */
router.post('/exit/resign', validate(resignSchema), auditLog('exit', 'RESIGN', 'resignation'), hrmsController.submitResignation);
/**
 * @swagger
 ...
 *         $ref: '#/components/responses/InternalError'
 */
router.patch('/exit/:employeeId/clearance/:departmentId', validate(updateClearanceSchema), auditLog('exit', 'CLEAR', 'clearance'), hrmsController.updateClearance);
/**
 * @swagger
 ...
 *         $ref: '#/components/responses/InternalError'
 */
router.post('/documents/request-letter', validate(requestLetterSchema), auditLog('document', 'REQUEST', 'letter'), hrmsController.requestLetter);
