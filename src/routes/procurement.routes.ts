 ...
 * tags:
 *   name: Procurement
 *   description: Procurement Management - Vendors, RFQs, Purchase Orders, Receipts
 */
 ...
 *   get:
 *     summary: Get vendors purchase history by ID
 *     tags: [Procurement]
 *     security:
 *       - bearerAuth: []
 *     parameters:
...
/**
 * @swagger
 * /procurement/rfqs/{id}/send:
 *   post:
 *     summary: Create rfqs send
 *     tags: [Procurement]
 *     security:
 *       - bearerAuth: []
 *     parameters:
...
/**
 * @swagger
 * /procurement/rfqs/{id}/quotes:
 *   get:
 *     summary: Get rfqs quotes by ID
 *     tags: [Procurement]
 *     security:
 *       - bearerAuth: []
 *     parameters:
...
/**
 * @swagger
 * /procurement/rfqs/create-po-from-quote:
 *   post:
 *     summary: Create rfqs create po from quote
 *     tags: [Procurement]
 *     security:
 *       - bearerAuth: []
 *     responses:
 ...
 *   get:
 *     summary: List purchase orders export
 *     tags: [Procurement]
 *     security:
 *       - bearerAuth: []
 *     responses:
 ...
 *   post:
 *     summary: Create purchase orders submit
 *     tags: [Procurement]
 *     security:
 *       - bearerAuth: []
 *     parameters:
 ...
 *   post:
 *     summary: Create purchase orders receipts
 *     tags: [Procurement]
 *     security:
 *       - bearerAuth: []
 *     parameters:
 ...
 * /procurement/purchase-orders/{id}/receipts:
 *   get:
 *     summary: Get purchase orders receipts by ID
 *     tags: [Procurement]
 *     security:
 *       - bearerAuth: []
 *     parameters:
